...
import { Brand, IconButton, Segmented, type BuilderTheme } from "./shell";
...
import { PrivatePreviewControls } from "./PrivatePreviews";
...
import { resolveShared, resolveSiteDocument } from "../../shared/builderSite";
...
export default function PageEditor(props) {
  ...
  return (
    <LibraryContext.Provider value={props.workspace.assets}>
