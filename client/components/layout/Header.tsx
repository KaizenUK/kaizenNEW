            ...
            <div className="hidden lg:flex items-center gap-1" ref={dropdownRef}>
                ...
                <AnimatePresence>
                  {openDropdown === "services" && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-2 w-screen max-w-2xl rounded-2xl border border-white/10 bg-gray-900/95 shadow-2xl p-8"
                      style={{
                      ...
                      <div className="grid grid-cols-2 gap-12">
                        {servicesMenu.map((column) => (
                          <div key={column.title}>
                            <h3 className="text-sm font-semibold text-white/90 uppercase tracking-wide mb-6 opacity-60">
                              {column.title}
                            </h3>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown 
                    size={16} 
                    className={`transition-transform duration-200 ${openDropdown === "insights" ? "rotate-180" : ""}`}
                  />
                </button>
                ...
                <AnimatePresence>
                  {openDropdown === "insights" && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -8 }}
                      transition={{ duration: 0.15 }}
                      className="absolute top-full right-0 mt-2 w-80 rounded-2xl border border-white/10 bg-gray-900/95 shadow-2xl p-6"
                      style={{
                        backdropFilter: "blur(20px)",
                      }}
                    >
                ...
                <div className="px-6 py-4 space-y-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <ChevronDown 
                        size={16} 
                        className={`transition-transform duration-200 ${expandedMobileSection === "services" ? "rotate-180" : ""}`}
                      />
                    </button>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <ChevronDown 
                        size={16} 
                        className={`transition-transform duration-200 ${expandedMobileSection === "insights" ? "rotate-180" : ""}`}
                      />
                    </button>
