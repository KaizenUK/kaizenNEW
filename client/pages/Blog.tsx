...
export default function Blog() {
  ...
  return (
    <Layout>
      ...
      {/* Page Header - The Masthead */}
      <section className="bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white py-20 md:py-32 px-4">
        <div className="container mx-auto max-w-6xl">
          {/* Massive Graphic Header */}
          <motion.h1
            className="text-7xl md:text-9xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-800/20 mb-8 leading-none"
          ...
          {/* Sub-Headline */}
          <motion.p
            className="text-xl md:text-2xl text-white/70 mb-12 font-light leading-relaxed max-w-3xl"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Practical guides on Web Design, Agile Delivery, and Product Ownership.
          </motion.p>

          {/* Filter Bar - Horizontal Scrolling Glass Chips */}
          <motion.div
          ...
          >
            {allTags.map((tag) => (
              <motion.button
                ...
                className={`px-4 py-2 rounded-full font-mono text-sm font-bold whitespace-nowrap transition-all ${
                  selectedTag === tag
                    ? "bg-white text-black"
                    : "bg-white/10 backdrop-blur border border-white/10 text-white/70 hover:bg-white/20"
                }`}
