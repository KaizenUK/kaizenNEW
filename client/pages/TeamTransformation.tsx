        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <div className="space-y-4 mb-8 text-lg text-kaizen-text-light/80">
              <p>
                Your team might be stuck in old patterns. Waterfall processes,
                siloed departments, months between releases. We help you
                transform into an Agile, cross-functional team that ships
                regularly and adapts to change.
              </p>
              <p>
                This isn't about learning a methodology. It's about changing how
                your team actually works every day.
              </p>
            </div>
            ...
            <div className="space-y-3 mb-12">
              <div className="flex gap-3 items-start">
                <Check
                  className="text-kaizen-lime flex-shrink-0 mt-1"
                  size={20}
                />
            ...
            {[
              {
                title: "Assessment",
                description:
                  "We understand your current situation, challenges, and what your team actually needs.",
              },
              {
                title: "Design",
                description:
                  "We create a transformation plan tailored to your team's context, not a generic template.",
              },
              {
                title: "Implementation",
                description:
                  "We work with your team through the transition, supporting change at every step.",
              },
              {
                title: "Sustainability",
                description:
                  "We make sure improvements stick and become part of how your team works every day.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
      ...
      <section className="py-20 md:py-32 bg-kaizen-dark text-kaizen-text-light">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-kaizen-text-light/80 mb-8 max-w-2xl mx-auto">
            Let's chat about your team's current situation and what
