...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative p-8 rounded-3xl bg-white border border-slate-200 backdrop-blur-sm hover:border-amber-500/50 transition-all duration-300 h-full">
...
function FaqItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-lg font-semibold text-slate-900 group-hover:text-amber-600 transition-colors pr-8">
          {question}
        </span>
        <motion.div
