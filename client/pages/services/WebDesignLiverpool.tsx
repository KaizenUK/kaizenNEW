...
function LiverpoolDataBackground() {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="liverpool-lines" x1="0" x2="1" y1="0" y2="1">
    ...
    <Layout>
      ...
      <section className="py-24 px-4 bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-slate-900 dark:text-white mb-4">
              Typical Liverpool Web Designer vs Kaizen
            </h2>
      ...
      <div className="relative bg-slate-50 dark:bg-slate-900 py-12">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto bg-white dark:bg-slate-950/50 backdrop-blur-sm rounded-3xl border border-slate-200 dark:border-slate-800 p-8 md:p-12 shadow-2xl">
            <FaqSection
              heading="Liverpool Web Design FAQs"
              ...
              items={[
                {
                  ...
                  answer:
                    "Because we understand the local market. Whether you are based in the Commercial District or expanding from the Knowledge Quarter, we build sites that compete with global agencies without the bloated London retainer fees. We know the difference between a Law Centre brief and a Financial Services portal.",
                },
                {
