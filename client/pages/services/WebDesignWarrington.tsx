...
function FloatingOrbs() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <motion.div
        className="absolute w-[600px] h-[600px] rounded-full bg-gradient-to-br from-cyan-500/20 via-sky-500/10 to-transparent blur-3xl"
        animate={{
          x: [0, 100, 0],
          y: [0, -50, 0],
          scale: [1, 1.1, 1],
      ...
      />
      <motion.div
        className="absolute w-[400px] h-[400px] rounded-full bg-gradient-to-tr from-indigo-500/15 via-purple-500/10 to-transparent blur-3xl"
        animate={{
          x: [0, -80, 0],
          y: [0, 60, 0],
          scale: [1, 0.9, 1],
...
function FeatureCard({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 to-sky-500/10 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      <div className="relative p-8 rounded-3xl bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 h-full">
        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500 to-sky-500 flex items-center justify-center text-white mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
          <Icon size={28} />
        </div>
...
function FaqItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-lg font-semibold text-slate-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors pr-8">
          {question}
        </span>
        <motion.div
...
export default function WebDesignWarrington() {
  ...
  const sectors = [
    {
      ...
      location: "Omega Business Park",
      description:
        "Websites and portals that keep your clients updated — tracking, documents, and live information without the clutter.",
    },
    {
      icon: Cog,
      ...
      description:
        "Clear, professional websites for technical businesses. Show what you do, who you work with, and how to get in touch.",
    },
    {
      icon: Building2,
      ...
      description:
        "From consultants to construction — we build sites that look established and make it easy for clients to enquire.",
    },
  ];
  ...
  const faqs = [
    {
      question: "Why choose a web design agency in Warrington?",
      answer:
        "Because we understand local businesses. Whether you are based at Omega, Birchwood, or in the town centre, we know what Warrington businesses need — a website that looks professional, loads quickly, and brings in work.",
    },
    {
      question: "Can you build client portals or tracking systems?",
      answer:
        "Yes. If you need a place for clients to log in, check orders, or access documents, we can build it. We keep things simple and only add features that genuinely help your team.",
    },
    {
    ...
    {
      question: "Can you help if our current website is slow or broken?",
      answer:
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://kaizenweb.co.uk/web-design-warrington"
        />
      </Helmet>
        ...
        >
          <div className="max-w-3xl">
            ...
            >
              <button
                onClick={() => openCrisp()}
                className="group inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-cyan-500 to-sky-500 text-white font-bold text-lg shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 hover:-translate-y-1"
              >
      ...
      <section className="py-24 px-4 bg-slate-950 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-16">
            ...
            >
              We work with businesses across Warrington — from Omega to
              Birchwood to the town centre. We understand what local businesses
              need.
            </motion.p>
          </div>
      ...
      <section className="py-32 px-4 bg-slate-950 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 text-center">
          ...
          >
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-sky-400">
              That Works
            </span>
          </motion.h2>
          ...
          >
            Whether you need a new website, a client portal, or help fixing what
            you have — we are here to help. No pressure, no hard sell. Just a
            proper conversation.
          </motion.p>
          ...
          >
            <button
              onClick={() => openCrisp()}
              className="group inline-flex items-center justify-center gap-3 px-10 py-5 rounded-full bg-gradient-to-r from-cyan-500 to-sky-500 text-white font-bold text-lg shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 hover:-translate-y-1"
            >
              Start a Chat
              <ArrowRight
                size={20}
