...
Apply the legal/privacy and retention migrations before the matching account function and frontend at the L5 milestone. Verify the active version/hashes and cron configuration, then check public page availability and sign-in loading without accepting on Sean's behalf. Live/manual acceptance, privacy-address delivery, operator queue review cadence and legal/provider review remain goal-end actions.
